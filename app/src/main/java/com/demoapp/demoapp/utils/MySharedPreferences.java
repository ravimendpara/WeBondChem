...
public class MySharedPreferences {
    ...
    Context context;
    private static final String PREFERENCES_CONTROL_DEMO_APP = "demo_app";
    ...
    public MySharedPreferences(Context context) {
        ...
        sharedPreferencesForUserDetails = context.getSharedPreferences(PREFERENCES_CONTROL_DEMO_APP, MODE_PRIVATE);
