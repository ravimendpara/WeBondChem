...
public class DistributorRedeemProductAdapter extends RecyclerView.Adapter<DistributorRedeemProductAdapter.MyViewHolder>{
    ...
    private IDistributorOnRedeemPoint iRedeemProductDistributor;

    public DistributorRedeemProductAdapter(Context context, ArrayList<GetRedemProductListPojo> getRedemProductListPojoArrayList) {
        this.context = context;
        this.getRedemProductListPojoArrayList = getRedemProductListPojoArrayList;
        layoutInflater = LayoutInflater.from(context);
        mySharedPreferences = new MySharedPreferences(context);
        iRedeemProductDistributor = (DistributorRedeemProductAdapter.IDistributorOnRedeemPoint) context;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.distributor_redeem_product_list_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DistributorRedeemProductAdapter.MyViewHolder holder, int position) {
    ...
    private void redeemProductApiCall(String RedemProductId, String RedemPoint, String Qty) {
        ...
        ApiImplementer.SaveRedeemData(RedemProductId, RedemPoint, "2", "0", "0", mySharedPreferences.getDistributorId(), Qty, new Callback<ArrayList<SaveRedemDataPojo>>() {
            @Override
                    ...
                    if (response.code() == 200 && response.body() != null) {
                        if (response.body().size() > 0) {
                            ...
                            if(saveRedemDataPojos.getStatus() == 1){
                                iRedeemProductDistributor.onRedeemPoints(RedemPoint);
...
//                                iRedeemProductDistributor.productRedeemed();
                            }else{
    ...
    public interface IDistributorOnRedeemPoint{
