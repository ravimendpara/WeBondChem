...
public class DistributorStockActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getStockReportList("2", mySharedPreferences.getDistributorId());
    }

    private void initView() {
        imgBack = findViewById(R.id.imgBack);
        svAdminReport = findViewById(R.id.svAdminReport);
        mySharedPreferences = new MySharedPreferences(DistributorStockActivity.this);
    ...
    private void generateDynamicStockReport(ArrayList<StockReportByIdPojo> adminStockReportPojoArrayList) {
        ...
        for (int i = 0; i <= adminStockReportPojoArrayList.size(); i++) {
            ...
            LinearLayout llDynamicAdminStockReport = new LinearLayout(DistributorStockActivity.this);
    ...
    private TextViewMediumFont createDynamicTextView(int txtBoxWidth, String txtBoxValue) {
        LinearLayout.LayoutParams txtBoxLayoutParam = new LinearLayout.LayoutParams(
                CommonUtil.convertDpToPxe(DistributorStockActivity.this,txtBoxWidth), LinearLayout.LayoutParams.MATCH_PARENT);
        TextViewMediumFont textViewMediumFont = new TextViewMediumFont(DistributorStockActivity.this);
...
//        textViewMediumFont.setTextSize(15);
        ...
        textViewMediumFont.setBackground(ContextCompat.getDrawable(DistributorStockActivity.this,
