...
public class DistributorManageAllCustomerForDistOnlyAdapter extends RecyclerView.Adapter<DistributorManageAllCustomerForDistOnlyAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<GetCustomerListForDistributorPojo> getCustomerListPojoArrayList;
    private LayoutInflater layoutInflater;

    public DistributorManageAllCustomerForDistOnlyAdapter(Context context, ArrayList<GetCustomerListForDistributorPojo> getCustomerListPojoArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DistributorManageAllCustomerForDistOnlyAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DistributorManageAllCustomerForDistOnlyAdapter.MyViewHolder holder, int position) {
