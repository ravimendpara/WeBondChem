...
public class AdminApproveDistributorOrderAdapter extends RecyclerView.Adapter<AdminApproveDistributorOrderAdapter.MyViewHolder>{

    private Context context;
    private ArrayList<GetDistributorOrderListPojo> getDistributorOrderListPojoArrayList;
    private LayoutInflater layoutInflater;

    public AdminApproveDistributorOrderAdapter(Context context, ArrayList<GetDistributorOrderListPojo> getDistributorOrderListPojoArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.inflater_distributor_approve_order_list_item, parent, false);
