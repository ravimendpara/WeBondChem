...
public class AdminPendingRedeemReqListAdapter extends RecyclerView.Adapter<AdminPendingRedeemReqListAdapter.MyViewHolder> {
    ...
    public AdminPendingRedeemReqListAdapter(Context context, ArrayList<GetRedemListAdminPojo> getRedemListAdminPojoArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.pending_admin_redeem_req_list_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminPendingRedeemReqListAdapter.MyViewHolder holder, int position) {
...
//        }
        ...
        if (!CommonUtil.checkIsEmptyOrNullCommon(getRedemListAdminPojo.getSchemeProductImagePathLink())) {
            Picasso.get().load(getRedemListAdminPojo.getSchemeProductImagePathLink().trim()).fit()
        ...
        holder.btnApprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showAlertDialogForApproveReject(getRedemListAdminPojo, position, "Approve", true);
            }
        });
        ...
        holder.btnReject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showAlertDialogForApproveReject(getRedemListAdminPojo, position, "Reject", false);
            }
        });
    }
...
//            tvCode = itemView.findViewById(R.id.tvCode);
    ...
    private void showAlertDialogForApproveReject(GetRedemListAdminPojo getRedemListAdminPojo, int position, String msg, boolean isFromApprove) {
        builder.setMessage("Are you sure you want to " + msg + "?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        if (isFromApprove) {
                            approveOrRejectRedeemRequestApiCall(getRedemListAdminPojo.getRedemId() + "", "1", getRedemListAdminPojoArrayList, position);
                        } else {
