...
public class GetProductListPojo {
    ...
    @SerializedName("DistributorPoint")
    @Expose
    private String distributorPoint;
    @SerializedName("DealerPoint")
    @Expose
    ...
    public String getDistributorPoint() {
        return distributorPoint;
    }

    public void setDistributorPoint(String distributorPoint) {
        this.distributorPoint = distributorPoint;
    }

    public String getDealerPoint() {
        return dealerPoint;
    }

    public void setDealerPoint(String dealerPoint) {
