...
public class DealerCustomerPendingOrderAdapter extends RecyclerView.Adapter<DealerCustomerPendingOrderAdapter.MyViewHolder>{
    ...
    public DealerCustomerPendingOrderAdapter(Context context, ArrayList<GetCustomerOrderListPojo> getCustomerOrderListPojoArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.inflater_manage_customer_pending_order_list_item, parent, false);
