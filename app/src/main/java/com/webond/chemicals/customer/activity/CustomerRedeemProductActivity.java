...
public class CustomerRedeemProductActivity extends AppCompatActivity implements View.OnClickListener, CustomerRedeemProductAdapter.ICustomerOnRedeemPoint {

    public static String CUSTOMER_TOTAL_POINTS="customer_total_points";
    private MySharedPreferences mySharedPreferences;
    private RecyclerView rvCustomerRedeemProductList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_redeem_product);
        initView();
    ...
    private void initView() {
        mySharedPreferences = new MySharedPreferences(CustomerRedeemProductActivity.this);
        imgBack = findViewById(R.id.imgBack);
        imgBack.setOnClickListener(this);
        tvHeaderTitle = findViewById(R.id.tvHeaderTitle);
        tvHeaderTitle.setText("Redeem Product");
        rvCustomerRedeemProductList = findViewById(R.id.rvCustomerRedeemProductList);
        rvCustomerRedeemProductList.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
...
//        rvCustomerRedeemProductList.setVisibility(View.GONE);
        ApiImplementer.GetRedemProductList("4", mySharedPreferences.getCustomerId(), new Callback<ArrayList<GetRedemProductListPojo>>() {
            @Override
...
//                            rvCustomerRedeemProductList.setVisibility(View.VISIBLE);
                            rvCustomerRedeemProductList.setAdapter(new CustomerRedeemProductAdapter(CustomerRedeemProductActivity.this, response.body()));
                        } else {
//                            totalPoint = "0";
                            llLoading.setVisibility(View.GONE);
                            fmRedeem.setVisibility(View.GONE);
...
//                rvCustomerRedeemProductList.setVisibility(View.GONE);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CustomerRedeemProductActivity.this,CustomerDashboardActivity.class);
        intent.putExtra(CUSTOMER_TOTAL_POINTS, totalPoint);
        setResult(IntentConstants.REQUEST_CODE_CUSTOMER_REDEEM_REQ, intent);
        super.onBackPressed();
    }
